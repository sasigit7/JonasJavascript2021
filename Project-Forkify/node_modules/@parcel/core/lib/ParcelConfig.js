...
class ParcelConfig {
  constructor(config, packageManager, fs, shouldAutoInstall) {
    ...
    _defineProperty(this, "shouldAutoInstall", void 0);
  ...
  static deserialize(serialized) {
    return new ParcelConfig(serialized.config, serialized.packageManager, serialized.fs, serialized.shouldAutoInstall);
  }
  ...
  loadPlugin(node) {
    ...
    plugin = (0, _loadParcelPlugin().default)(this.fs, this.packageManager, node.packageName, node.resolveFrom, node.keyPath, this.shouldAutoInstall);
