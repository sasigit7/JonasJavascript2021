...
class Graph {
  ...
  getNodesConnectedTo(node, type = null) {
    ...
    if (type === ALL_EDGE_TYPES) {
      ...
      nodes = (_inboundByType$get$va2 = (_inboundByType$get2 = inboundByType.get(type)) === null || _inboundByType$get2 === void 0 ? void 0 : _inboundByType$get2.values()) !== null && _inboundByType$get$va2 !== void 0 ? _inboundByType$get$va2 : [];
    }
  ...
  getNodesConnectedFrom(node, type = null) {
    ...
    if (type === ALL_EDGE_TYPES) {
      ...
      nodes = (_outboundByType$get$v2 = (_outboundByType$get2 = outboundByType.get(type)) === null || _outboundByType$get2 === void 0 ? void 0 : _outboundByType$get2.values()) !== null && _outboundByType$get$v2 !== void 0 ? _outboundByType$get$v2 : [];
    }
