...
async function loadConfig(cachePath, options) {
  ...
  processedConfig, options.packageManager, options.inputFS, options.shouldAutoInstall);
...
async function runPackage(workerApi, {
  ...
  let parcelConfig = new (_ParcelConfig().default)(processedConfig, options.packageManager, options.inputFS, options.shouldAutoInstall);
