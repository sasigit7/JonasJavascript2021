...
async function _generateFromAST(asset) {
  ...
  let {
    plugin
  } = await (0, _loadParcelPlugin().default)(asset.options.inputFS, asset.options.packageManager, pluginName, (0, _nullthrows().default)(asset.value.configPath), (0, _nullthrows().default)(asset.value.configKeyPath), asset.options.shouldAutoInstall);
